...
public class IJoinSelectedSessionButton : MonoBehaviour, IInputClickHandler
{
    /// <summary>
    ...
    /// </summary>
    private IScrollingSessionListUIController scrollingUIControl;
    ...
    {
        IScrollingSessionListUIController.Instance.JoinSelectedSession();
        eventData.Use();
    }
}