...
/// </summary>
public class IScrollingSessionListUIController : SingleInstance<IScrollingSessionListUIController>
{
    /// <summary>
    ...
    /// </summary>
    private Dictionary<string, INetworkDiscovery.SessionInfo> sessionList;
    ...
    /// </summary>
    public ISessionListButton[] SessionControls;

    /// <summary>
    /// Keeps track of the session the user has currently selected.
    /// </summary>
    public INetworkDiscovery.SessionInfo SelectedSession { get; private set; }
    ...
    public void ScrollSessions(int Direction)
    {
        ...
        for (int index = 0; index < SessionControls.Length; index++)
        {
            if (SessionIndex + index < sessionCount)
            {
                ...
                INetworkDiscovery.SessionInfo sessionInfo = sessionList.Values.ElementAt(SessionIndex + index);
    ...
    public void SetSelectedSession(INetworkDiscovery.SessionInfo sessionInfo)
    {
