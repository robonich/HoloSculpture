...
public class IPlayerController : NetworkBehaviour, IInputClickHandler
{
    private static IPlayerController _Instance = null;
    /// <summary>
    ...
    // Anchor Establish するのはいいのだけど、 Establish した結果を別に教えなくてもいいような気がする
    // ここから
    /// <summary>
