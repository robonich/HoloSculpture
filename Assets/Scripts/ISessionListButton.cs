...
/// </summary>
public class ISessionListButton : MonoBehaviour, IInputClickHandler
{
    /// <summary>
    /// Information about the session attached to this button
    /// </summary>
    private INetworkDiscovery.SessionInfo SessionInfo;
    ...
    /// </summary>
    private IScrollingSessionListUIController scrollingUIController;
    ...
    private void Awake()
    {
        ...
        scrollingUIController = IScrollingSessionListUIController.Instance;
    ...
    public void SetSessionInfo(INetworkDiscovery.SessionInfo sessionInfo)
    {
